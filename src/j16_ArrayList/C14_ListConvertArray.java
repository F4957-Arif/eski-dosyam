...
public class C14_ListConvertArray {
    public static void main(String[] args) {
        ...
        //Object Class java'da parent i olmayan tek Class tır.(Tüm vagonları ceken ama cekılemez lokomotiftir)
        //String Integer Class'lar Object Class child i oldugu için istenendurumlarda data type olarak obje ctclass kullanabilir.
