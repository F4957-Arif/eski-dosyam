...
public class C01_MethodCreation {
    public static void main(String[] args) {//main metod başlangıcı
 /*
...
*/
    ...
    public static int topla4(String str, int a) {//String ve integer paremetreyi int return eden method
    ...
    public static int topla3() {//parametresiz ama integer return type bir method
        int a = 72;
        int b = 63;
...
// Best practice-> method'lar main method'dan sonra create edilir.
    ...
    public  static void topla (){//Paremetresiz return type olmayan void bir method call oedilid
        int a=33;
        int b=23;
    ...
    public  static  void topla2(int a, int b){//paremetrelı(2 int) void method
        System.out.println("bu method parametreli :) ");
        System.out.println(a+b);
        System.out.println("topla2 çalıstı ");
    }
