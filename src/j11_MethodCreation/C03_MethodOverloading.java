...
topla(35, 3.14);
topla(3.5, 8.9);
//topla("3",5);//String integer type castıng uygun olmadıgı ıcın CTE hatası verır
    }//main sonu
    //parametrenının sayısı yıpı sırası desıınce overloadıng olur yukardısakı ornek

    public static void topla(int sayi1, int sayi2){
        System.out.println("int-int type method çalıstı-> "+(sayi1+sayi2));
    }

    public static void topla(double sayi1, int sayi2){
        System.out.println("double-int type method çalıstı-> "+(sayi1+sayi2));
    }
    public static void topla(int sayi1, double sayi2){
        System.out.println("int-double type method çalıstı-> "+(sayi1+sayi2));
    }
    public static void topla(double sayi1, double sayi2){
        System.out.println("double-double type method çalıstı-> "+(sayi1+sayi2));
    }
