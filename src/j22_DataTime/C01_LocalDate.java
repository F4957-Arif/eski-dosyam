...
public class C01_LocalDate {
    public static void main(String[] args) {
        ...
        System.out.println("bugün = " + bugun);//2022-10-25
        ...
        LocalDate date1=LocalDate.of(1923,10,29);//1923-11-10
        LocalDate date2=LocalDate.of(1923, Month.OCTOBER,29);//1924-01-29

        //verılen bir tarıhın oncesı ve sonrarsına gitme mınus->once tarıh, plus->sonnrası
        ...
        System.out.println("bugun.plusDays(43).minusMonths(2).plusWeeks(3).minusYears(2) = " + bugun.plusDays(43).minusMonths(2).plusWeeks(3).minusYears(2));//2020-10-28
