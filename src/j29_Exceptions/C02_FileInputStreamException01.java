...
public class C02_FileInputStreamException01 {
    ...
    public static void main(String[] args) throws IOException {//Hz.Nuh IO işlemleri en parent class exception
        ...
        /*
        eğer bir method da Checked(CTR riski olan excp.) exception varsa method signature(mrthod nameden sonrakı bolum) hata uyarısı altı kırmızı cızgı verır
        komutun derlemesıne ızın ermez ve kod üzerine geldiğinde Add. exception handle etme tavsiye eder otomatık trows excp eklenır.
        Bu şekilde method call eden komutlar try-catch alınmasını garantı edilmiş olur
         */
