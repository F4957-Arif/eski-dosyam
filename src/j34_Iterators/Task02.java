...
output: [23,40]
    */
        ...
        List<Integer> liste2 = new ArrayList<>(Arrays.asList(2,13,56,23,45,14,40));
        System.out.println("Listenin ilk hali: "+liste2);
        ListIterator<Integer> ıter = liste2.listIterator();
        while (ıter.hasNext()){
            int i = ıter.next();
            if (i>=20 && i <=40){
                System.out.print(i+" ");
