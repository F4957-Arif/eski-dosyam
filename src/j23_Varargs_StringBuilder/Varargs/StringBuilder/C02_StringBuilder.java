 ...
 */
        ...
        String str1="javaCAN";
        System.out.println("karsılastır = " + sb5.compareTo(sb6));
       // System.out.println("str ile karsılastırmadan = " + sb5.compareTo(str1));//hata verır(elma armut kıyaslanmaz)CTE verır
        System.out.println("sb6.compareTo(str1) = " + sb6.compareTo(new StringBuilder(str1)));
        System.out.println("eşit mi = " + sb6.equals(sb5));//false->SB equels ==gibi çalısır->hem value hemde raf degerıne bakar
        System.out.println("sb6.equals(sb6) = " + sb6.equals(sb6));//true


        System.out.println("str1.equals(sb6.toString()) = " + str1.equals(sb6.toString()));//true cunkku toString Strıng e cevirdi...
