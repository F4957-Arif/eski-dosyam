...
public class C01_Varargs {
    public static void main(String[] args) {
        ...
        toplaVarargs(20,35,sayi1,sayi3);
        //verılen Strıng lerın en fazla karekter sayıanı tespıt eden method creat edınız
enUznunKelıme("aga","yusuf","gokhan","yiğihamza");
...
// Task -> verilen üç sayı toplamını print eden METHOD create ediniz
    ...
    public static void enUznunKelıme(String... str){
        String enUZUN="";
        for (String v:str) {
        ...
        System.out.println("en uzun kelıme " + enUZUN);
    }
}
