 ...
 */
    ...
    private C01_AccessModifier() {//paremetresiz
        System.out.println("agama privatcons. selam");
    }

    public C01_AccessModifier(int privateYas, int defaultYas) {//publıc 2 pli cons
    ...
    protected void protectedMethod(){
        System.out.println("protecdet methoddan agaya slm");

    }
    C01_AccessModifier obj3=new C01_AccessModifier();//privata cons edlır .
