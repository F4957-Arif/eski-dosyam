...
public class C01_WhileLoop {
        ...
        /*
        başlangıc ve bıtıs degerleri net(bilinen degerler) olan tekrarlarda foor loop ama adım sayısı bellı olmayıp bir şarta
        (duruma) bağlı olan tekrarlarda while loop kullanılmalı
         */
    //Task-->11 den 20' ye kadar olan tamsayıları prınt eden code creat edınız
