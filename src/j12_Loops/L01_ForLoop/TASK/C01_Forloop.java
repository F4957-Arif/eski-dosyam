...
//
      ...
      // }
        // çalışmayan loop
        for (int i = 1; i <141 ; i++) {//şartı sağlamayan->False olan for body run almaz
                                      // kod kırılarak sıradaki satırdan(46) devam eder
            System.out.println("selam javacan");

        }
        System.out.println("agam bu metni okuduysan yukarıdaki for çalışmadı");
        // durmayan sonsuz loop
        for (int i = 0; i < 41 ; i++) {//bu for çuğarayı cüpiterden yakana kadar çalışır:)
                                        // durduran aşk olsun
