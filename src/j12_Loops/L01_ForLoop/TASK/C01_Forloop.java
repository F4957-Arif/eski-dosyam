...
public class C01_Forloop {
    public static void main(String[] args) {
        //410 kere maşaallah print ediniz...
        ...
        /*
        loop-->döngü tekrarlana aksıyonlar ıcın kullanılan cade blok larıdır

         */
     for (int i=1; i<=41; i++){
         System.out.println(i+"maaşallah");
     }
        System.out.println("selam javacanlar bolcana ofter :");//dongu dışı 1 kez run eder
        //TASK-->2 basamaklı tek sayıları yan yana print eden code create edınız 11, 13, 15
