...
public class C02_DataTypes {
    public static void main(String[] args) {
        ...
        int yil=22;
            ...
            //TASK->1992 yılında doğan bir kişinin yaşını yazdırınız....
        int dTarihi= 1999;
        int buYıl=2022;
        int yasiniz =buYıl-dTarihi;
        System.out.println(yasiniz);
        float f1=12.45f;
        float f2=23.56f;
        double boy=1.85;
        System.out.println(f1*f2);//12.45*23.56 =293.322s
        //TASK-> iki farkli byte tanımlayıp taplam farkını print ediniz
        byte a=23, b=24;
        System.out.println(a+b);//67
        System.out.println(a-b);//-11
        //TASK-> iki farklı tamsayı türünden sayı tanımlayıp toplam farkını print ediniz
        int c=1453;
        byte d=34;
        System.out.println(c+d);//1487
        //TASK->tamsayı ve ondalık sayı tanımlayıp toplam print ediniz
        int n=33;
        double m=14.53;
        System.out.println(n+m);//47.53-->33.0+14.53
        //TASK->tamsayı ve char sayı tipinde iki variable tanımlayıp toplam print ediniz
        int sayi=63;
        char para='&';
        System.out.println(sayi+para);// & ascii değeri 36 olarak aritmetik işleme girdi
